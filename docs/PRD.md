...
- Segurança: regras do Firestore devem impedir leitura/escrita fora do `couple_id`.
...
- Observabilidade futura: erros de Firestore devem manter contexto de operacao e caminho.
...
- Fotos serao apenas URLs externas ou via Firebase Storage?
