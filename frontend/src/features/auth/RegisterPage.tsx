...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-50 dark:bg-[#0f1115]">
      ...
      <div className="relative z-10 w-full max-w-md p-8 sm:p-12 glass rounded-2xl sm:border border-slate-200/50 dark:border-white/5 shadow-2xl my-8">
        <div className="text-center mb-8">
          <div className="inline-flex w-14 h-14 rounded-2xl bg-gradient-to-br from-rose-400 to-rose-600 items-center justify-center shadow-lg shadow-rose-500/20 mb-4">
            <span className="text-white text-3xl">❤</span>
          </div>
          <h1 className="font-serif text-3xl font-medium tracking-wide mb-2 text-slate-900 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-white dark:to-slate-300">
            Criar Espaço
          </h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm">Comece a guardar a história de vocês.</p>
        </div>
        ...
        >
          ...
          {loading ? 'Aguarde...' : 'Criar Conta com Google'}
        </button>
        ...
        <p className="border-t border-slate-200/50 dark:border-white/5 mt-8 pt-8 text-center text-sm text-slate-500 dark:text-slate-400">
          Já têm uma conta?{' '}
          <Link href="/login" className="text-rose-500 dark:text-rose-400 hover:text-rose-600 dark:hover:text-rose-300 font-medium transition-colors">
            Entrar
          </Link>
        </p>
      </div>
